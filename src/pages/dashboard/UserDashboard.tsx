            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Via agent or card</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium">
                      {transaction.type === 'transfer' && `Sent to ${transaction.recipient}`}
                      {transaction.type === 'received' && `Received from ${transaction.sender}`}

            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Add money to customer wallet</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Withdraw from customer wallet</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Your latest cash-in/out operations</CardDescription>
            </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium">
                      {transaction.type === 'cash_in' ? 'Cash In' : 'Cash Out'} - {transaction.customer}
                    </p>

  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 left-20 w-24 h-24  rounded-full animate-pulse-slow" />
        <div className="absolute bottom-32 right-10 w-12 h-12  rounded-full animate-bounce-subtle" />
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" className="w-full h-8 fill-background">
